...
export const slidesPart2 = [
  {
    ...
    content: (
      <div>
        <img src="https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2NjQ4Nzh8MHwxfHNlYXJjaHwxMHx8c2NhbGFibGUlMjBidXNpbmVzcyUyMG1vZGVsJTIwaW5mb2dyYXBoaWN8ZW58MHx8fHwxNzM5NzQzNjI5fDA&ixlib=rb-4.0.3&q=80&w=1080"
          alt="Business model"
  ...
  },
  {
    ...
    content: (
      <div>
        <img src="https://images.unsplash.com/photo-1650959828226-f9d53a7c1f64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2NjQ4Nzh8MHwxfHNlYXJjaHw1fHxncm93dGglMjBjaGFydCUyMHdpdGglMjB1cHdhcmQlMjB0cmVuZHxlbnwwfHx8fDE3Mzk3NDM2Mjl8MA&ixlib=rb-4.0.3&q=80&w=1080"
          alt="Growth chart"
          className="w-full max-h-96 object-cover rounded-lg mb-4"
  ...
  },
  {
    ...
    content: (
      <div>
        <img src="https://images.unsplash.com/photo-1697820536894-59f79079687e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2NjQ4Nzh8MHwxfHNlYXJjaHw5fHxzaWRlLWJ5LXNpZGUlMjBjb21wYXJpc29uJTIwc2hvd2luZyUyMFpBUFQlMjBhZHZhbnRhZ2VzfGVufDB8fHx8MTczOTc0MzYyOXww&ixlib=rb-4.0.3&q=80&w=1080"
  ...
  },
  {
    ...
    content: (
      <div>
        <img src="https://images.unsplash.com/photo-1521830101529-057b1dfd9784?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2NjQ4Nzh8MHwxfHNlYXJjaHw1fHxkaXZlcnNlJTIwdGVhbSUyMGNvbGxhYm9yYXRpbmclMjBvbiUyMHRlY2hub2xvZ3l8ZW58MHx8fHwxNzM5NzQzNjI5fDA&ixlib=rb-4.0.3&q=80&w=1080"
